// Profil pour les rendez-vous créés par le secrétariat.
// Un rendez-vous lie : un patient, un soignant et une salle.
...
// On veut 3 participants : un patient, un soignant, une salle
* participant 3..* MS
...
// Le soignant : on demande son RPPS pour que les RH
// puissent retrouver les RDV par numéro RPPS
...
// Règle : la fin doit être après le début
